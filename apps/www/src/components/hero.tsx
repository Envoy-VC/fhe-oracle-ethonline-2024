...
export const Hero = () => {
  return (
    <section id=''>
      <div className='hero-bg relative my-12 h-[60dvh] w-full rounded-[3rem]'>
        ...
        <div className='absolute top-1/2 flex w-full -translate-y-1/2 flex-col items-center justify-center gap-6 px-4 text-center text-white'>
          ...
          <p className='max-w-3xl text-sm'>
            ...
            Fhenix blockchain. Computes or fetches data using Lit Protocol
      ...
      <div className='mx-4 h-[60dvh] w-full rounded-[3rem] bg-[#F1F2FD]'>a</div>
    </section>
  );
};
